...
namespace TestProject
{
    public class TestProjectRepository
    {
        ...
        {
            MissionID = new Guid("0DD62430-80CA-44A5-B16D-5FBF04324341"),
            MName = "Создать БД",
            ...
            Project = new Project(),
            EmployeeID = new Guid("0DD62430-80CA-44A5-B16D-5FBF04324342"),
            ProjectID = new Guid("0DD62430-80CA-44A5-B16D-5FBF04324343"),
            MStatus = "В процессе",
            MType = "Технологический отдел"
        };
        Mission mission2 = new Mission
        {
            MissionID = new Guid("0DD62430-80CA-44A5-B16D-5FBF04324351"),
            MName = "Написать программу",
            MDescription = "Написать программу на C##",
            DateStart = new DateTime(2021, 11, 25),
            DateEnd = new DateTime(2021, 11, 28),
            Employee = new Employee(),
            Project = new Project(),
            EmployeeID = new Guid("0DD62430-80CA-44A5-B16D-5FBF04324352"),
            ProjectID = new Guid("0DD62430-80CA-44A5-B16D-5FBF04324353"),
            MStatus = "Завершено",
            MType = "Технологический отдел"
        };
